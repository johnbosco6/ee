...
const transactionsData = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: '67', title: 'WORLDREMIT BG. r', amount: '-2050,50 PLN', balance: '151,16 PLN', icon: 'ShoppingCart' },
      { id: '68', title: 'JAKUB HANUS UL. CYPRIANA...', amount: '2500,00 PLN', balance: '5,33 PLN', icon: 'CreditCard', isPositive: true },
